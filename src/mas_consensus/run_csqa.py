...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run CSQA experiments.")
    parser.add_argument(
        "--sample_id",
        type=int,
        default=3,
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Number of malicious agents. Default: run with 0, 1, 2",
    )
    parser.add_argument(
        "--graph_type",
        type=str,
    ...
    attacker_nums = [args.attacker_num] if args.attacker_num is not None else [0, 1, 2]
