...
class AgentGraph:
    ...
    def re_generate(self):
        ...
        for idx in range(self.num_agents):
            ...
            prompt += f"Task: {self.tasks[idx]}"
            prompt += "\nBased on your previous view, memory and the views of other agents below, provide an updated response and a new memory summary regarding the discussion."
            ...
            prompt += (
                "\n<UPDATED_MEMORY>: {Summarize the new memory in less than 150 words.}"
            )
...
def process_data(
    ...
    You are a strong supporter for the statement that: {}
    Determine whether the following statement is correct (answer with True/False) with reasoning and final answer:
    Statement: {}
    Reference Answer: {}
    In your response:
    ...
    """.format(statement, statement, "True")
